  ...
  <div class="w-full mb-8 overflow-hidden rounded-lg">
      @include('backend.layouts.flash')
        <div class="w-full overflow-x-auto px-10">
            <form action="{{ route('admin.posts.update',$post->id) }}" method="POST" id="post-create-form"> 
                @method('PUT')
            @csrf
            ...
            <label class="block text-sm mb-4">
                ...
                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                placeholder="What is this life, if full of care">{{ $post->excerpt }}</textarea>
            ...
            <label class="block text-sm mb-4">
                ...
                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                placeholder="What is this life, if full of care">{{ $post->content }}</textarea>
            </label>
