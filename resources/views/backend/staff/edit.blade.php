...
@section('content')
  <div class="w-full mb-8 overflow-hidden rounded-lg ">
        <div class="w-full overflow-x-auto px-10">
            ...
            <form action="{{ route('admin.staffs.update',$staff->id) }}" method="POST" id="staff-update-form"> 
            @csrf
            @method('PUT')
...
{!! JsValidator::formRequest('App\Http\Requests\backend\StaffUpdateRequest', '#staff-update-form'); !!}
