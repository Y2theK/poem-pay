...
<x-app-layout>
    <div class="mx-auto w-full py-14 px-10 max-w-5xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-10">
                        ...
                        <div class="flex w-full justify-between items-center">
                            ...
                            <div class="w-full flex justify-between items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-gray-600 mr-3">Like : {{ $post->reactions_count }}</small>
                                        <small class="text-gray-600 mx-3">Comment : {{ $post->comments_count }}</small>
