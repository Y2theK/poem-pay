    ...
    <div class="infinite-scroll">
        <div class="flex justify-center flex-col items-center">
            ...
            @forelse ($posts as $post)
                <div
                    class="w-full  mb-2 py-5 px-3 max-w-5xl {{ $post->is_exchanged ? 'bg-white' : 'bg-gray-100' }} border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
