                ...
                <div
                    ...
                    <div class="flex justify-center">
                        ...
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1180.7 781.6"
                            style="enable-background:new 0 0 1180.7 781.6;" xml:space="preserve" width="406"
                            height="306">
                            <style type="text/css">
                                .st0 {
                                    fill: none;
                    ...
                    C624.3,291.3,540.2,283.9,543,225.4z" />
                            <path class="st3"
                                d="M557.8,757.9c-7.9-159.5-15.8-319-23.6-478.7v0l-0.2-3.8c0,0-6.9-11.4-6.1-22.8c0.5-6.6,0-13.3-1.5-19.8
                    ...
                    C921.3,110.3,913.8,126.3,913.8,145.5z" />
                            ...
                            <path class="st2"
                                d="M823.9,188.2c0,0,1.5-12.4,7.2-46.1c6.9-41.3-11.7-52.8-49.2-18.9s14.6,79,14.6,79L823.9,188.2z" />
                    ...
                    s14.7,164.3,5.7,154c-69.7-80-75.3-77.6-75.3-77.6L708.9,421.3z" />
                            <path class="st7"
                                d="M692.2,742.4c-4.8,1.5-9.6,2.8-14.5,4.1c-15.1,3.9-30.6,7-46.4,9c-0.5,0.1-0.9,0.1-1.4,0.2
                    ...
                    " />
                            <path class="st5"
                                d="M668,274.3c-10.4-43.7-29.6-42.3-39.1-45.2c-8.5-2.6-24-4-11.4,6.3s30.2,37.6,30.2,37.6" />
                    ...
                    s10.5-24.5,2.6-31.9s-25.1-10.3-25.1-10.3s-3.1,2.9-4.7,27.3C546.5,133.4,546.3,151.4,546.4,168.4z" />
                            <path class="st3"
                                d="M631.3,755.4c-0.5,0.1-0.9,0.1-1.4,0.2l-8.5-472.4l0-0.4l1.3,0.1l0,0.4L631.3,755.4z" />
                            <path class="st3"
                                d="M547.5,118.5c0,0-0.5-32.4,19.5-40.3c21.2-8.3,48.7-9.8,72.7,10.7c0,0,5.9,6.9,8,14.1
