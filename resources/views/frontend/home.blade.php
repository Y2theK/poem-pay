                    ...
                    <div class='flex max-w-xl my-3 bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
                        <div class='flex items-center w-full'>
                            <div class='w-full'>
                                <div class="flex flex-row mt-2 px-2 py-3 mx-3">
                                    <div class="w-auto h-auto rounded-full border-2 border-pink-500">
                                        <img class='w-12 h-12 object-cover rounded-full shadow cursor-pointer'
                                            alt='User avatar' src={{ $post->user?->getAvatarPath() }}>
                                    </div>
                                    <div class="flex flex-col mb-2 ml-4 mt-1">
                                ...
                                <div class="border-b border-gray-100"></div>
                                <div class='text-gray-600 font-semibold text-lg mb-2 mt-6 mx-3 px-2'>{{ $post->title }}
                                </div>
                                <div class='text-gray-500 font-thin text-sm mb-6 mx-3 px-2'>{!! $post->excerpt !!}</div>
                                <div class="flex justify-start mb-4 border-t border-gray-100">
                                    <div class="flex w-full mt-1 pt-2 pl-5">
                                        <span
                                            class="bg-white transition ease-out duration-300 hover:text-red-500 border w-8 h-8 px-2 pt-2 text-center rounded-full text-gray-400 cursor-pointer mr-2">
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="15px"
                                ...
                                <div class="flex w-full border-t border-gray-100">
                                    <div class="mt-3 mx-5 flex flex-row">
                                        ...
                                        <div
                                            class='flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center'>
                                            Views: <div class="ml-1 text-gray-400 font-thin text-ms"> {{ rand(300, 1000) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3 mx-5 w-full flex justify-end">
                                ...
                                <div
                                    ...
                                    <img class='w-10 h-10 object-cover rounded-full shadow mr-2 cursor-pointer'
                                        alt='User avatar' src={{ $user->getAvatarPath() }}>
                                    <span class="absolute inset-y-0 right-0 flex items-center pr-6">
                                        <button type="submit"
                                            class="p-1 focus:outline-none focus:shadow-none hover:text-blue-500">
                                            <svg class="w-6 h-6 transition ease-out duration-300 hover:text-blue-500 text-gray-400"
            ...
            <div class='flex max-w-xl my-3 bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
                <div class='flex items-center w-full'>
                    <div class='w-full'>
                        ...
                        <div class="border-b border-gray-100"></div>
                        <div class='text-gray-600 font-semibold text-lg mb-2 mt-6 mx-3 px-2'>Dummy text of the printing
                            and
                            typesetting industry</div>
                        <div class='text-gray-500 font-thin text-sm mb-6 mx-3 px-2'>Lorem Ipsum is simply dummy text of
                            the
                            printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                            ever
                            since the 1500. Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                            roots
                            ...
                            the
                            word in classical orem Ipsum is simply dummy text of the
                            printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                            ever
                            since the 1500. Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                            roots
                            ...
                            H.
                            Rackham literature, discovered the undoubtable source. Lorem Ipsum comes from sections
                            1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by
                            Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular
                            during
                            the Renaissance. The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a
                        ...
                        <div class="flex w-full border-t border-gray-100">
                            <div class="mt-3 mx-5 flex flex-row">
                                ...
                                <div class='flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center'>
                                    Views: <div class="ml-1 text-gray-400 font-thin text-ms"> 60k</div>
                                </div>
                            </div>
                            <div class="mt-3 mx-5 w-full flex justify-end">
                                <div class='flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center'>
                                    Likes: <div class="ml-1 text-gray-400 font-thin text-ms"> 120k</div>
                                </div>
                            </div>
                        </div>
                        <div
