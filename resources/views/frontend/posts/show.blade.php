            ...
            <div class='flex items-center w-full'>
                <div class='w-full'>
                    <div class="">
                        ...
                        <div
                            class="relative border dark:border-gray-700 dark:bg-gray-900 text-dark  flex items-center self-center w-full max-w-xl p-4 overflow-hidden text-gray-600 dark:text-gray-200">
