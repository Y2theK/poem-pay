        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-900 border border-white dark:border-gray-800">
                ...
                <form class="p-4 md:p-5" action={{ route('posts.store') }} method="POST">
                    ...
                    <button type="submit"
                        class="text-white border border-white dark:border-gray-800 inline-flex items-center bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
