 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
     <div class="flex justify-between h-16">
         <div class="flex items-center justify-center font-bold">
             ...
             @else
                 <!-- Logo -->
                 <div class="shrink-0  w-5 back-btn cursor-pointer">
                    <svg class="text-purple-600 size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
