<div
    ...
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        ...
        <a type="button" href="{{ route('scan_and_pay') }}"
            class="inline-flex rounded-lg flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <svg class="w-4 h-4 mb-1 {{ areActiveRoutes(['scan_and_pay'], 'text-purple-600') }} text-gray-500 dark:text-gray-400 group-hover:text-purple-600 dark:group-hover:text-purple-500"
            ...
            <span
                class=" text-gray-500 dark:text-gray-400  {{ areActiveRoutes(['scan_and_pay'], 'text-purple-600') }} group-hover:text-purple-600 dark:group-hover:text-purple-500" style="font-size: 10px">Scan</span>
        </a>
