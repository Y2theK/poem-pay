        ...
        <div class='flex items-center w-full'>
            <div class='w-full'>
                ...
                {{-- <div class='text-gray-600 font-semibold text-lg mb-2 mt-3 mx-3 px-2'>Share this post for better
                            reach</div> --}}
                <div class='text-gray-500 font-thin text-sm mb-2 mt-3 mx-3 px-2'>Lorem Ipsum is
                            ...
                            <div class='flex items-center w-full'>
                                <div class='w-full'>
                                    ...
                                    <div class="flex flex-row mt-2 px-2 py-3 mx-3">
                                        ...
                                        <div class="flex flex-col mb-2 ml-4 mt-1">
                                            <div class='text-gray-600 text-xs font-semibold'>Sara Lauren</div>
                                            <div class='flex w-full mt-1'>
                                    ...
                                    <div class="border-b border-gray-100"></div>
                                    <div class='text-gray-600 font-semibold text-lg mb-2 mt-3 mx-3 px-2'>Dummy
                                    ...
                                    <div class='text-gray-500 font-thin text-sm mb-6 mx-3 px-2'>Lorem Ipsum is
                                        ...
                                        standard dummy text
                                        ever
                                        since the 1500. Contrary to popular belief, Lorem Ipsum is not simply
                                        random text. It has
                                        roots
                ...
                <div class="flex justify-start mb-4 border-t border-gray-100">
                    <div class="flex w-full mt-1 pt-2 pl-5">
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="15px" viewBox="0 0 24 24"
